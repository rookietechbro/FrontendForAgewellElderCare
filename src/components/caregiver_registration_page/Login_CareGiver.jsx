    ...
    return (
        <div>
            ...
            <div style={{display:"flex", justifyContent:"center",alignItems:"center"}}>
                <div style={{backgroundColor:"grey",width:"1000px",paddingTop:"40px",paddingBottom:"40px",paddingLeft:"50px",borderRadius:"15px",paddingRight:"600px",display:"flex", justifyContent:"center",alignItems:"center",flexDirection:"column",marginTop:"80px"}}>
                    <Grid container
