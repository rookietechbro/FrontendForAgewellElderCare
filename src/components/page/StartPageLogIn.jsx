                ...
                <div className={style.background} style={{display:"flex", justifyContent:"center", alignItems:"center",marginTop:"80px"}}>
                    ...
                    <div style={{marginBottom:"150px"}}>
                        ...
                        <div style={{display: "flex", gap:"50px",justifyContent:"center", alignItems:"center"}}>
                            <Button onClick={()=>navigate("/login_CareGiver")} variant="contained" style={{fontSize:"2.0rem",color: "white", borderRadius:"5px", backgroundColor: " #070a3a",padding:"10px 35px"}}>
                                Care-Giver
                            </Button>
                            <Button onClick={()=>navigate("/login")} variant="contained" style={{fontSize:"2.0rem",color: "white", borderRadius:"5px", backgroundColor: " #070a3a",padding:"10px 10px"}}>
                                Senior Citizen
                            </Button>
                        </div>
                    </div>
