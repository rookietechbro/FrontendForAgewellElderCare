    ...
    return (
        <div>
            ...
            <div style={{display:"flex", justifyContent:"center",alignItems:"center"}}>
                <div style={{backgroundColor:"grey",width:"1000px",paddingTop:"40px",paddingBottom:"40px",paddingLeft:"50px",borderRadius:"15px",paddingRight:"600px",display:"flex", justifyContent:"center",alignItems:"center",flexDirection:"column",marginTop:"30px"}}>
                    <Grid container
                    ...
                    >
                        ...
                        <Grid item xs={12}>
                            <Typography sx={{fontSize:"2.8rem",fontWeight:"1000",marginLeft:"100px",width:"1200px"}}>
                                CAREGIVER'S REGISTRATION
                            </Typography>
                            <Container>
